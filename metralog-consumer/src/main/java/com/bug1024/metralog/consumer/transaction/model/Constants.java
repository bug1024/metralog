...
public class Constants {
   ...
   public static final String ATTR_LINE50VALUE = "line50Value";

   public static final String ATTR_LINE90VALUE = "line90Value";

   public static final String ATTR_LINE95VALUE = "line95Value";

   public static final String ATTR_LINE9999VALUE = "line9999Value";

   public static final String ATTR_LINE999VALUE = "line999Value";
   ...
   public static final String ELEMENT_LONGESTMESSAGEURL = "longestMessageUrl";
   ...
   public static final String ENTITY_GRAPH = "graph";

   public static final String ENTITY_GRAPHS = "graphs";

   public static final String ENTITY_GRAPH_TREND = "graph-trend";

   public static final String ENTITY_GRAPH2 = "graph2";

   public static final String ENTITY_GRAPH2S = "graph2s";
   ...
   public static final String ENTITY_RANGE2S = "range2s";

   public static final String ENTITY_STATUSCODE = "statusCode";

   public static final String ENTITY_STATUSCODES = "statusCodes";
